...
############################
# infolinux.sh - captura informações do sistema e mostra na tela
############################
#
# Autor: Marco Antônio Martins Júnior
# Contribuição: 
# Versão: 1.0
#
# Uso: ./infolinux.sh (como root)
#
# TODO: melhorar o relatório de ip para mostrar todos os ips do host separados por interface
#

#Interface de rede para capturar ip
IFNET="wlan0"
